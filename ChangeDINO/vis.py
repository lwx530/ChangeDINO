...
def save_feature_map(feature_tensor, save_name, save_dir="vis_results_2_20"):
    """
...
def main():
    ...
    print("2. 正在加载训练好的权重...")
    weight_path = "/home/linweixuan/ChangeDINO/checkpoints/ESDI-15/ESDI-15_mobilenetv2_best.pth"
    ...
    hook_handles.append(model.encoder.dense_adp.register_forward_hook(get_hook('3_dense_adp')))
    ...
    print("4. 正在读取并预处理图片...")
    img_path = "/home/linweixuan/ChangeDINO/datasets/ESDIs-SOD/test/images/2_20.jpg"
